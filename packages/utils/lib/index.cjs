...
var require$$0$2 = require('ignore');
var require$$1$1 = require('fs');
var require$$2 = require('path');
var require$$5 = require('@babel/types');
var require$$0 = require('@babel/parser');
var require$$1 = require('@vue/compiler-sfc');
var require$$0$1 = require('crypto');
var require$$4 = require('prettier');
var require$$7 = require('@babel/helper-module-imports');
var require$$8 = require('@babel/generator');
var require$$9 = require('@babel/traverse');
